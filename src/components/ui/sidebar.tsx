...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-xs tabular-nums bg-destructive text-white select-none pointer-events-none",
